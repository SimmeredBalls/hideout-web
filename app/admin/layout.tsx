...
import AdminSidebarIdentity from "@/components/admin/admin-sidebar-identity"; // Import new component
      ...
      <aside className="w-72 border-r border-zinc-800 bg-zinc-950 flex flex-col relative">
        ...
        <div className="p-8 z-10">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h2 className="text-2xl font-black tracking-tighter text-white italic uppercase">Hideout</h2>
          </div>
          <div className="flex items-center gap-2">
            <p className="text-[9px] text-zinc-500 uppercase tracking-[0.3em] font-black">System Operations</p>
        ...
        <div className="mt-auto p-6 border-t border-zinc-900 bg-zinc-950/80 backdrop-blur-md z-10">
          ...
          {/* Use Suspense here to handle the dynamic data fetching */}
          <Suspense fallback={<div className="mb-6 h-12 bg-zinc-900 animate-pulse rounded-lg" />}>
          ...
          <div className="mb-6 px-2">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[8px] font-mono text-zinc-500 italic uppercase">Secure</span>
             </div>
          </div>
          <LogoutButton />
        </div>
